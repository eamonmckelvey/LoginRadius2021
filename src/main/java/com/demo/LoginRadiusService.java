...
import com.loginradius.sdk.util.LoginRadiusSDK.Initialize;
...
public class LoginRadiusService {
	...
	public void init() {
		...
		//Seeing my Key and Secret
		Initialize.setApiKey("4e59164d-9098-4e3a-abe2-2c29d2cee9b6");
		Initialize.setApiSecret("0e92aed0-162a-4276-a63f-0e08cd4a8644");
